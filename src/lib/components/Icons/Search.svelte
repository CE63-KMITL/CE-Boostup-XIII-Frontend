<svg class="stroke-icon" fill="none" width="30" height="30" viewBox="0 0 35 36" xmlns="http://www.w3.org/2000/svg">
	<path
	...
	/>
	<path d="M30.625 31.125L24.2812 24.7812" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
</svg>
